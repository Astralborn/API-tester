...
class TestSettingsManagerProtocol:
    def test_mock_satisfies_protocol(self):
        class Stub:
            ...
            def get_last_simple_format(self): ...
            def set_last_simple_format(self, simple): ...
            def get_last_test_mode(self): ...
            def set_last_test_mode(self, mode): ...
            def get_last_json_type(self): ...
            def set_last_json_type(self, json_type): ...
            def get_last_endpoint(self): ...
            def set_last_endpoint(self, endpoint): ...
